...
export default function UserSect(){
...
{/* pristiaa profile */}
                                ...
                                <div className="profile-management">
                                    ...
                                    <div className="pristia-personal-info">
                                        ...
                                        <div className="pristia-info-table">
                                            <div className="info-table-two-sides">
                                                <div className="info-table-row">
                                                    <p className="first-name-grey">First Name</p>
                                                    <p className="user-name-dark">Pristia</p>
                                                </div>
                                                <div className="info-table-row">
                                                    <p className="first-name-grey">Last Name</p>
                                                    <p className="user-name-dark">Candra</p>
                                                </div>
                                                <div className="info-table-row">
                                                    <p className="first-name-grey">Phone Number</p>
                                                    <p className="user-name-dark">0813 563 3745</p>
                                                </div>
                                            </div>

                                            <div className="info-table-two-sides">
                                                <div className="info-table-row">
                                                    <p className="first-name-grey">Email</p>
                                                    <p className="user-name-dark">lincoln@gmail.com</p>
                                                </div>
                                                <div className="info-table-row">
                                                    <p className="first-name-grey">Birthday</p>
                                                    <p className="user-name-dark">12 May 1996</p>
                                                </div>
                                                <div className="info-table-row">
                                                    <p className="first-name-grey">Gender</p>
                                                    <p className="user-name-dark">Female</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>

                                    <div className="pristia-address">
                                         <div className="personal-info-heading">
                                            <p>Address</p>
                                        </div>
                                         ...
                                         <div className="pristia-street">
                                            <div className="user-street">
                                                <p className="user-zip-code">Street</p>
                                                <p className="zip-code">12 Martins Street</p>
                                            </div>
                                            <div className="user-street">
                                                <p className="user-zip-code">Zip Code</p>
                                                <p className="zip-code">364737</p>
                                            </div>
                                            <div className="user-street">
                                                <p className="user-zip-code">City</p>
                                                <p className="zip-code">Lagos</p>
                                            </div>
                                            <div className="user-street">
                                                <p className="user-zip-code">Country</p>
                                                <p className="zip-code">Nigeria</p>
                                            </div>
                                         </div>
                                    </div>
                                </div>
