...
export default function FraudDetection(){
  ...
  const handleActionToggle = (barIndex, actionType) => {
    ...
    return(
        <div className="accounts-overview call-management fraud-section">
            ...
            <div className="accounts-view">
                  <div className="admin-overview">
                    ...
                    <p>Manage fraud detections and alerts.</p>
                </div>
                  </div>
            </div>
             ...
             <div className="user-subscription">
                            ...
                            <div className="total-users">
                                <div className="daily-users bg-ash">
                                    <span>
                                        <p className='Totall'>Total </p><p className='dailyy'>/daily</p>
                                    </span>
                                    <div className="two-hundred-users bg-white">
                                        <p>200</p>
                                    </div>
                                </div>
                                <div className="daily-users">
                                        <p>Flagged</p>
                                    <div className="two-hundred-users bg-lightash">
                                        <p>120</p>
                                    </div>
                                </div>
                                <div className="daily-users bg-lightyellow">
                                        <p className='Suspended'>Suspended</p>
                                    <div className="two-hundred-users bg-yellow">
                                        <p>80</p>
                                    </div>
                                </div>
                                <div className="daily-users bg-lightred">
                                        <p className='Banned'>Banned</p>
                                    <div className="two-hundred-users bg-red">
                                        <p>23</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="users-details call-manage">
                                        ...
                                        <div className="users-profile users-id-type">
                                            ...
                                            <div className="flagged-status">
                                                <div className="permenant-id">
                                                    <div className="sub-permenant-id bg-g">
                                                        <img src={flag} alt="" />
                                                        <p className='permenent-bg-para permenent-bg-g-para'>Flagged</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flagged-status">
                                                <div className="permenant-id">
                                                    <div className="sub-permenant-id bg-lightyellow">
                                                        <div className="permenent-bg-b permenent-bg-g bg-yellow ">h</div>
                                                        <p className='permenent-bg-para permenent-bg-g-para Suspended'>Suspended</p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flagged-status">
                                                <div className="permenant-id">
                                                    <div className="sub-permenant-id bg-lightred">
                                                        <div className="permenent-bg-b bg-red">h</div>
                                                        <p className='permenent-bg-para Banned'>Banned</p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div className="last-action duration Note">
                                            <div className="number-heading action-heading note-heading">
                                                <p>Note</p>
                                            </div>   
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>High call volume to flagged regions</p>
                                                </div>
                                            </div>
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>Multiple failed login attempts	</p>
                                                </div>
                                            </div>
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>Fraudulent activities</p>
                                                </div>
                                            </div>
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>Suspicious behavior flagged by other users</p>
                                                </div>
                                            </div>
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>Breach in policy</p>
                                                </div>
                                            </div>
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                            ...
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>Multiple calls to flagged regions</p>
                                                </div>
                                            </div>
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>Frequent changes to Caller IDs</p>
                                                </div>
                                            </div>
                                            <div className="users-percentage id-type note-para">
                                                <div className="-id ">
                                                        <p className='hello'>Suspicious Caller ID being used for spam</p>
                                                </div>
                                            </div>
                                        </div>
        ...
        <div className="fa-bars" key={index}>
          ...
          {openIndex === index && (
            <div className="bars-dropdown">
              <div className="users-content"><p>View profile</p></div>
