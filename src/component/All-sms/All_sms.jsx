...
import messageGreen from "../../assets/messages-2.png"
import messageRed from "../../assets/messages-red.png"

export default function AllSmsSection(){
                        ...
                        <div className="profile-management">
                            <div className="profile-management-heading">
                                ...
                                <div className="pristia-profile">
                                    <Link id="heading-links" className="">
                                    <p>
                                   SMS logs
                                   </p>
                                    </Link>
                                ...
                                <div className="personal-info-heading">
                                    <div className="type-of-call">
                                        ...
                                        <div className="trans-calls-btn">
                                             <Link id="heading-link"
                                             className={`${getActiveClass('/AllSms/RegularSms')}`} 
                                             to="/AllSms/RegularSms"
                                            >
                                            <p>Regular SMS</p>
                                            </Link>
                                        </div>
                                        <div className="trans-calls-btn">
                                           <Link id="heading-link"
                                            className={`${getActiveClass('/RegularSms/DataSms')}`} 
                                            to="/RegularSms/DataSms"
                                           >
                                            <p>Data SMS</p>
                                            </Link>
                                        </div>
