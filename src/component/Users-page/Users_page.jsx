...
export default function UsersPageSection(){
    ...
    return(
        ...
        <div className="caller-section users-page">
                ...
                <div className="sub-callers-overview">
                    <div className="call-id">
                      <div className="admin-overview">
                        <div className="overview-heading faint-text">
                            <div className="pages-heading">
                            <h3 className="faint-text">Subscription</h3>
                            <img src={arrowRight} alt="" />
                            <p>Pristia Candra / Billing History</p>
                            </div>
        ...
        >
          Save
                ...
                <div className="callers-initial-info">
                  <div className="caller-users-name s-n">
                     ...
                     <div className="users-info">
                      ...
                      <div className="users-info">
                          ...
                          <div className="users-information">
                                ...
                                <div className="callers-subscription page-sub">
                                ...
                                <div className="callers-request-data page-sub">
                                 ...
                                 <div className="callers-status">
                                  <div className="number-heading profile-heading">
                                    ...
                                    <div className="status-type">
                                     ...
                                     <div className="callers-phone-number page-sub">
                                    ...
                                    <div className="more-actions">
                                         <div className="no-action">
                                             <p>null</p> 
                                              ...
                                              {bars.map((_, index) => ( <div className="fa-bars" key={index}>
                                                 <img src={bar} alt="toggle" onClick={() => toggleDropdown(index)} /> {openIndex === index && ( <div className="bars-dropdown userpage-dropdown">
                                             <div className="users-content">
                                                 <p>Send Warning</p>
                                            </div> 
                                             
                                             <div className="users-content">
                                             <p className='revoke-action'>Deactivate subscription</p>
                                             </div>
                                              </div> )} </div> ))} </div>
                                    </div>
